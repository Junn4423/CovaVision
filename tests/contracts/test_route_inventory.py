...
ROUTE_TEST_MATRIX: dict[tuple[str, str], str] = {
    ...
    ("GET", "/api/v1/departments"): "api/test_departments.py",
    ("POST", "/api/v1/departments"): "api/test_departments.py",
    ("DELETE", "/api/v1/departments/{department_id}"): "api/test_departments.py",
    ("GET", "/api/v1/positions"): "api/test_departments.py",
    ("POST", "/api/v1/positions"): "api/test_departments.py",
    ("DELETE", "/api/v1/positions/{position_id}"): "api/test_departments.py",
