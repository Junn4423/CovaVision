  ...
  return <SafeAreaView style={styles.safe}>
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <View style={styles.card}>
        ...
        <Text style={styles.subtitle}>Quản lý camera, nhân viên và dữ liệu chấm công.</Text>
...
const styles = StyleSheet.create({
  ...
  card: {backgroundColor: '#fff', borderRadius: 24, padding: 24, gap: 14, shadowColor: '#0f172a', shadowOpacity: 0.08, shadowRadius: 18, elevation: 3},
  eyebrow: {color: '#2563eb', fontWeight: '800', letterSpacing: 2},
  title: {fontSize: 28, fontWeight: '800', color: '#0f172a'},
  subtitle: {color: '#64748b', lineHeight: 20, marginBottom: 8},
  input: {borderWidth: 1, borderColor: '#cbd5e1', borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12, color: '#0f172a'},
  error: {color: '#dc2626'},
  button: {backgroundColor: '#2563eb', borderRadius: 12, minHeight: 48, alignItems: 'center', justifyContent: 'center'},
